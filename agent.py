...
GEMINI_MODEL = _secret_or_env("GEMINI_MODEL", "gemini-1.5-flash")
GEMINI_CLASSIFIER_MODEL = _secret_or_env("GEMINI_CLASSIFIER_MODEL", "gemini-1.5-flash-lite")
...
GEMINI_FALLBACK_MODEL = _secret_or_env("GEMINI_FALLBACK_MODEL", "gemini-1.5-flash")
